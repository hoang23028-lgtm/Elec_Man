...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column(
            "image_id", sa.Uuid(), sa.ForeignKey("images.id", ondelete="RESTRICT"), nullable=False
        ),
        sa.Column("model_version", sa.String(128), nullable=False),
        sa.Column("customer_id_ai", sa.String(128)),
        sa.Column("meter_reading_ai", sa.String(64)),
        sa.Column("customer_confidence", sa.Float(), nullable=False),
        sa.Column("meter_confidence", sa.Float(), nullable=False),
        ...
        sa.Column("raw_result_json", postgresql.JSONB(astext_type=sa.Text()), nullable=False),
        sa.Column(
