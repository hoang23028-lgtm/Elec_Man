...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column("batch_code", sa.String(40), nullable=False),
        sa.Column("original_folder_name", sa.String(255), nullable=False),
        sa.Column("total_images", sa.Integer(), nullable=False, server_default="0"),
        sa.Column("uploaded_images", sa.Integer(), nullable=False, server_default="0"),
        ...
        sa.Column("ng_count", sa.Integer(), nullable=False, server_default="0"),
    ...
    op.create_table(
        ...
        sa.Column("id", sa.Uuid(), primary_key=True),
        sa.Column(
            "batch_id", sa.Uuid(), sa.ForeignKey("batches.id", ondelete="RESTRICT"), nullable=False
        ),
        ...
        sa.UniqueConstraint("batch_id", "sha256", name="uq_images_batch_sha256"),
    )
