...
Bộ xử lý hiện tại là `OCR_BASELINE`. Nó ghi lại chất lượng, OCR, vùng phát hiện, độ tin cậy và phiên bản mô hình. Kết quả đầy đủ vượt ngưỡng tự động xác nhận được ghi thẳng vào dữ liệu cuối cùng; các đầu ra còn lại vào hàng chờ kiểm duyệt. Đây là bộ khởi đầu dựng sẵn để thu thập nhãn đã xác minh, không phải mô hình đồng hồ điện sản xuất đã huấn luyện.
